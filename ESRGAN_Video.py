...
def run(args):
    num_process = args.num_process if hasattr(args, 'num_process') else 1  # Assign a default value
...
def main():
    ...
    parser.add_argument('-i', '--input', type=str, default=r'sttire.mp4', help='Input video, image or folder')
    parser.add_argument(
        '-n',
        '--model_name',
        type=str,
    ...
    parser.add_argument('-o', '--output', type=str, default=r'E:\mywork\Working\Real-ESRGAN', help='Output folder')
    parser.add_argument(
        '-dn',
        '--denoise_strength',
        type=float,
        default=1,
        help=('Denoise strength. 1.0 for no denoising. '
              'Lower values for stronger denoising. Default: 1.0'))
    parser.add_argument(
        '-s',
        '--suffix',
        type=str,
        default='out',
        help='Suffix of the restored video. Default: out')
    parser.add_argument(
        '-ss',
        '--outscale',
        type=float,
        default=4.0,
        help='Output scale. Default: 4.0')
    parser.add_argument(
        '-t',
        '--tile',
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='Pre padding size. Default: 10')
    parser.add_argument(
        '--face_enhance',
        action='store_true',
    ...
    parser.add_argument(
        '--fp32',
        action='store_true',
        help='Use fp32 precision during inference. Default: False')
    parser.add_argument(
        '--extract_frame_first',
        action='store_true',
        help='Extract frames first before restoration. Default: False')
    parser.add_argument(
        '--num_process_per_gpu',
        type=int,
        default=1,
    ...
    parser.add_argument(
        '--fps',
        type=float,
        help='Specify the output video fps. If not specified, use the same fps as the input video.')
